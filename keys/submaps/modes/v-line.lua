...
Submap.define({
  ...
  binds = function()
    local rows = {
      ...
      { "c",         function() lm.reset() reg.handle_delete("CTRL", "x", "INSERT") end },
      { "SHIFT + x", function() wk.close() lm.reset() reg.handle_delete("", "BackSpace", "NORMAL") end, "BackSpace", { repeating = true } },
      { "x",         function() lm.reset() reg.handle_delete("CTRL", "x", "NORMAL") end, nil, { repeating = true } },
      { "d",         function() lm.reset() reg.handle_delete("CTRL", "x", "NORMAL") end, "Delete", { repeating = true } },
