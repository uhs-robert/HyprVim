...
local function move(x, y)
  return function() hl.dispatch(hl.dsp.window.move({ x = x, y = y, relative = true })) end
end
...
hl.define_submap("Move", function()
  ...
  hl.bind("F", function() hl.dispatch(hl.dsp.window.float({ action = "toggle" })) end, { desc = "Toggle Floating" })
