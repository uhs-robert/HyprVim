...
hl.define_submap("Cursor", function()
  ...
  for _, tier in ipairs(scroll_tiers) do
    hl.bind(tier.mod .. "E",      exec("wlrctl pointer scroll "  .. tier.step .. " 0"),  { desc = "Scroll Up"    .. tier.label, repeating = true })
    hl.bind(tier.mod .. "Y",      exec("wlrctl pointer scroll -" .. tier.step .. " 0"),  { desc = "Scroll Down"  .. tier.label, repeating = true })
    hl.bind(tier.mod .. "COMMA",  exec("wlrctl pointer scroll 0 -" .. tier.step),        { desc = "Scroll Left"  .. tier.label, repeating = true })
    hl.bind(tier.mod .. "PERIOD", exec("wlrctl pointer scroll 0 "  .. tier.step),        { desc = "Scroll Right" .. tier.label, repeating = true })
  end
